...
function createServer(basedir, opts) {
  ops = opts || {}
  ...
  function handle(req, res) {
    ...
    if (uri === '/') {
      ...
      // console.log(opts)
      fs.createReadStream(__dirname + '/../index.html').pipe(opts.injectcss ? css : opts.injectvdom ? vdom : res);
      return; //send(res, index, 'text/html')
    }
